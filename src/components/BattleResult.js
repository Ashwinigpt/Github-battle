            ...
            <div className=' flex justify-evenly align-center'>
                ...
                <h1>{this.handleWinner(score1, score2)}</h1>
                  <div className='img-container'>
                      <img className='full-width' src={user1.avatar_url} alt='user'/>
                  </div>
                  <h6>Score: {score1}</h6><br/>
                  <h2>{user1.login}</h2>
                  <ul>
                      <li>
                      ...
                      <li>
                      <i class="fas fa-user-friends"></i> {user1.following} Following
                      </li>
                      <li>
                      <i class="fas fa-code"></i> {user1.public_repos} Repositories
                      </li>
                ...
                <h1>{this.handleWinner(score2, score1)}</h1>
                  <div className='img-container'>
                      <img className='full-width' src={user2.avatar_url} alt='user'/>
                  </div>
                  <h6>Score: {score2}</h6><br/>
                  <h2>{user2.login}</h2>
                  <ul>
                  <li>
                      ...
                      <li>
                      <i class="fas fa-user-friends"></i> {user2.following} Following
                      </li>
                      <li>
                      <i class="fas fa-code"></i> {user2.public_repos} REpositories
                      </li>
